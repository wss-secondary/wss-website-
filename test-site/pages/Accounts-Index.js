var firebaseConfig = {
  ...
  var listRef =storageRef.child("Student-resources/Accounts") ;
  
  // Variables
  var ref1  = "Student-resources/Accounts/"
  ...
  const storageRefOne = storage.ref('Student-resources/Accounts/');
  ...
  async function getFileInfo() {
    ...
    fileInfo.items.forEach(async item => { //Go through each file and render to DOM
      ...
      //Create path to file
      let pathToFile = `Student-resources/Accounts/${item.name}`;
